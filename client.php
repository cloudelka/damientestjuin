...
// requete db de récupération des proverbes suivant pagination

// requête envoyée à mysql et récupération du résultat dans $recup_prov
$recup_prov = mysqli_query($mysqli, $sql);
//PAGINATION//
?>
<!DOCTYPE html>
<html>
    ...
    <body><div id="haut">
        <?php
        if (!isset($_SESSION['sid']) || $_SESSION['sid'] != session_id()) {
    echo "<h1>Telepro-photos.fr - Espace Client</h1>";
}else{
    echo "<h1>Telepro-photos.fr - Espace Client</h1>";
